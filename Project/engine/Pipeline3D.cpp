...
void Pipeline3D::SubmitCommandBuffer() const
{
	const VulkanBase& vulkanBase{ VulkanBase::GetInstance() };
	const SwapChain& swapChain{ vulkanBase.GetSwapChain() };
...
VkPipelineDynamicStateCreateInfo Pipeline3D::CreateDynamicState(const std::vector<VkDynamicState>& dynamicStates)
{
...
VkPipelineVertexInputStateCreateInfo Pipeline3D::CreateVertexInfo()
{
...
VkPipelineInputAssemblyStateCreateInfo Pipeline3D::CreateInputAssembly()
{
...
VkPipelineViewportStateCreateInfo Pipeline3D::CreateViewportState()
{
...
VkPipelineRasterizationStateCreateInfo Pipeline3D::CreateRasterizer()
{
...
VkPipelineMultisampleStateCreateInfo Pipeline3D::CreateMultisampling()
{
...
VkPipelineColorBlendAttachmentState Pipeline3D::CreateColorBlendAttachment()
{
...
VkPipelineColorBlendStateCreateInfo Pipeline3D::CreateColorBlend(VkPipelineColorBlendAttachmentState* colorBlendAttachment)
{
